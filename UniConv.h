...
public:
	...
	/*{@ */
		...
		static constexpr const char* c99_encoding = "C99";
		static constexpr const char* java_encoding = "JAVA";

		// Full Unicode, in terms of uint16_t or uint32_t
		static constexpr const char* ucs_2_internal_encoding = "UCS-2-INTERNAL";
		static constexpr const char* ucs_4_internal_encoding = "UCS-4-INTERNAL";

		// Locale dependent
		static constexpr const char* char_encoding = "char";
		static constexpr const char* wchar_t_encoding = "wchar_t";

		// Extra encodings (when configured with --enable-extra-encodings)
		static constexpr const char* cp437_encoding = "CP437";
		static constexpr const char* cp737_encoding = "CP737";
		static constexpr const char* cp775_encoding = "CP775";
		static constexpr const char* cp852_encoding = "CP852";
		static constexpr const char* cp853_encoding = "CP853";
		static constexpr const char* cp855_encoding = "CP855";
		static constexpr const char* cp857_encoding = "CP857";
		static constexpr const char* cp858_encoding = "CP858";
		static constexpr const char* cp860_encoding = "CP860";
		static constexpr const char* cp861_encoding = "CP861";
		static constexpr const char* cp863_encoding = "CP863";
		static constexpr const char* cp865_encoding = "CP865";
		static constexpr const char* cp869_encoding = "CP869";
		static constexpr const char* cp1125_encoding = "CP1125";
		static constexpr const char* cp864_encoding = "CP864";
		static constexpr const char* euc_jisx0213_encoding = "EUC-JISX0213";
		static constexpr const char* shift_jisx0213_encoding = "Shift_JISX0213";
		static constexpr const char* iso_2022_jp_3_encoding = "ISO-2022-JP-3";
		static constexpr const char* big5_2003_encoding = "BIG5-2003";
		static constexpr const char* tds565_encoding = "TDS565";
		static constexpr const char* atarist_encoding = "ATARIST";
		static constexpr const char* riscos_latin1_encoding = "RISCOS-LATIN1";
...
private:
	...
	std::unordered_map<std::string, IconvSharedPtr>                         m_iconvDesscriptorCacheMapS;
private:
	...
	/// 清理iconv 描述符缓存
	/// </summary>
	void                           CleanupIconvDescriptorCache();
