...
/***************************************************************************/
	/**
	 * @brief Convert a UTF-16LE encoded string to the current locale encoding.
	 * @param  sInput The UTF-16LE encoded string to be converted.
	 * @return The converted string in the current locale encoding.
	 * @retval val std::string
	 */
...
/***************************************************************************/
	...
	/**
	 * @brief Convert a C-style UTF-8 string to a wide string.
	 * @param sInput The C-style UTF-8 string to be converted.
	 * @return The converted wide string.
	 * @retval val std::wstring
	 * @todo delete this method
	...
	/**
	 * @brief Convert a C-style wide string to a UTF-8 string.
	 * @param sInput The C-style wide string to be converted.
	 * @return The converted UTF-8 string.
	 * @retval val std::string
	 */
...
/***************************************************************************/
	 ...
	 * @return The converted wide string.
	 * @retval val std::wstring
	 * @todo finish the c-style method
	 */
...
private:
	 ...
	 * @return The conversion result as an IConvResult structure.
	 * @retval IConvResult
	 * @note This method performs the actual conversion using iconv and returns the result.
	 */
	IConvResult                         Convert(std::string_view in, const char* fromcode, const char* tocode);

	/**
	 * @brief Convert a wide string to another encoding using iconv.
	 * @param in The input wide string to be converted.
	 * @param fromcode The source encoding.
	 * @param tocode The target encoding.
	 * @return The conversion result as an IConvResult structure.
